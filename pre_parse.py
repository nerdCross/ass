...
def parseWords(inp,unique_id):
    ...
    # tokens = nltk.sent_tokenize(var)
    # num_divisor = getDivisor(len(tokens))
    ...
    # print("number of divisor: ", num_divisor)

    # for idx, token in enumerate(tokens):
    #     if current_file_name == "":
    #         current_file_name = file_path+"/"+file_name+str(file_ctr)+".txt"
    #         current_file = open(current_file_name, "w")
    #         current_file.write("''' \n")
    #         ctr = 0

    #         print("--------------")
    #         print("writing at index: ", idx)
    #         current_file.write(token)
    #         current_file.write("\n")
    #         ctr +=1

    #     elif ctr > num_divisor -1 and len(tokens)-idx >= num_divisor:
    #         print("idx at cut off: ", idx)
    #         print("==================")
    #         # close current file
    #         current_file.write("''' \n")
    #         current_file.close()
